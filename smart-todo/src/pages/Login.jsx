...
export default function Login() {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      openDialog({ type: "success", title: "Login Successful" });
      ...
      <div className="px-6 py-3 rounded min-w-[300px] shadow-lg w-[21.216vw] bg-white">
        ...
        <form ref={formRef} onSubmit={loginFormHandler}>
          ...
          <div className="flex flex-col my-2">
            ...
            <input name="username" className="text-[clamp(14px,0.586vw,24px)] border-b-[0.23148148148148vh] rounded px-3 py-1 mt-2 emailIcon" type="text" placeholder="Type your username" />
          </div>
